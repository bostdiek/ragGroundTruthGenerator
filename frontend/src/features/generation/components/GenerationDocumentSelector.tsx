...
interface GenerationDocumentSelectorProps {
  documents: AppDocument[];
  selectedDocuments: AppDocument[];
  onSelectDocument: (document: AppDocument) => void;
  isLoading?: boolean;
  error?: string | null;
}
...
/**
 * Component for displaying and selecting documents in the generation feature
 * This is a modified version of the DocumentSelector specific to the generation feature
 */
const GenerationDocumentSelector: React.FC<GenerationDocumentSelectorProps> = ({
  documents,
  selectedDocuments,
  onSelectDocument,
  isLoading = false,
...
export default GenerationDocumentSelector;
