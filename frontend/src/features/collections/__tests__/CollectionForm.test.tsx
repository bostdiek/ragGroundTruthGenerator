...
describe('Collection Creation', () => {
  ...
  it('renders the collection creation form', () => {
    ...
    expect(
      screen.getByText(/Create a new collection to organize your Q&A pairs/i)
    ).toBeInTheDocument();
...
describe('Collection Editing', () => {
  ...
  it('loads and displays existing collection data for editing', async () => {
    ...
    expect(
      screen.getByDisplayValue('This is an existing collection')
    ).toBeInTheDocument();
